...
function setup() {
  ...
  boggie1 = new Boggies(50,170,50,50);
  boggie2 = new Boggies(150,170,50,50);
  boggie3 = new Boggies(250,170,50,50);
  boggie4 = new Boggies(350,170,50,50);
  boggie5 = new Boggies(450,170,50,50);
  boggie6 = new Boggies(550,170,50,50);
